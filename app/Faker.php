...
class Faker
{
    ...
    public static function fakeTanggals()
    {
        $tanggals = collect([
            [ 'name' => '12 November 2021'],
            [ 'name' => '13 November 2021'],
            [ 'name' => '14 November 2021'],
            [ 'name' => '15 November 2021'],
            [ 'name' => '16 November 2021'],
            [ 'name' => '17 November 2021'],
            [ 'name' => '18 November 2021'],
            [ 'name' => '19 November 2021'],
            [ 'name' => '20 November 2021'],
            [ 'name' => '21 November 2021']
        ]);

        return $tanggals->shuffle();
    }
