...
@section('subcontent')
   <h2 class="intro-y text-lg font-medium mt-10">Cara Booking</h2>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-b dark:border-dark-5">
                            <img class="object-contain" src="{{ asset('storage/'.$item->foto) }}" alt="">
                        </td>
                        <td class="border-b dark:border-dark-5 w-56">
                            <form action="{{ route('caradelete',$item->id) }}" method="post" >
                                @csrf
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="{{ route('caraedit', $item->id) }}">
        ...
        <div class="intro-y col-span-6 overflow-auto lg:overflow-visible">
            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box p-5">
                    <form  method="POST" action="{{ route('caraupdate', $cara->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <label for="crud-form-1" class="form-label">Keterangan</label>
                        <input id="crud-form-1" value="{{ $cara->keterangan }}" name="keterangan" type="text" class="form-control w-full" placeholder="Keterangan Gambar">
                    </div>
                    <div class="mt-3">
                        <img class="object-contain md:object-scale-down" src="{{ asset('storage/'.$cara->foto) }}" alt="">
                    </div>
                    <div class="mt-3">
                        <label for="crud-form-2" class="form-label">Ganti Gambar disi</label>
                        <input id="crud-form-2" name="foto" type="file" class="form-control w-full" placeholder="Keterangan Gambar">
                    </div>
                    <div class="text-right mt-5">
                        <button type="button" action="{{ route('datacara') }}" class="btn btn-outline-secondary w-24 mr-1">Cancel</button>
