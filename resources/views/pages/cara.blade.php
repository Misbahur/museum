        ...
        <div class="intro-y col-span-6 overflow-auto lg:overflow-visible">
            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box p-5">
                    <form  method="POST" action="{{ route('caraadd') }}" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <label for="crud-form-1" class="form-label">Keterangan</label>
                        <input id="crud-form-1" name="keterangan" type="text" class="form-control w-full" placeholder="Keterangan Gambar">
                    </div>
                    <div>
                        <label for="crud-form-2" class="form-label">Gambar</label>
