        ...
        <div class="intro-y col-span-6 overflow-auto lg:overflow-visible">
            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box p-5">
                    <form method="POST" action="{{ route('socialadd') }}" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <label for="crud-form-1" class="form-label">Nama</label>
                        <input id="crud-form-1" name="nama" type="text" class="form-control w-full" placeholder="Input nama social">
                    </div>
                    <div>
                        <label for="crud-form-2" class="form-label">Logo Medsos</label>
                    ...
                    <div>
                        ...
                        <input id="crud-form-3" name="title" type="text" class="form-control w-full" placeholder="Input Title social">
                    </div>
                    <div>
                        <label for="crud-form-4" class="form-label">Link Medsos</label>
                        <input id="crud-form-4" name="link" type="text" class="form-control w-full" placeholder="Input Link social">
                    </div>
