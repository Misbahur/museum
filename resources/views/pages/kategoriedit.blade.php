        ...
        <div class="intro-y col-span-6 overflow-auto lg:overflow-visible">
            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box p-5">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('kategoriupdate', $kategori->id) }}" >
                    @csrf
                    <div>
                        <label for="crud-form-1" class="form-label">Nama Kategori</label>
                        <input id="crud-form-1" name="nama" type="text" class="form-control w-full" value="{{ $kategori->nama }}" placeholder="Input nama kategori">
                    </div>
                    <div class="mt-3">
                        ...
                        <select data-placeholder="-- Pilih satu --" name="jenis" class="tail-select w-full" id="crud-form-2">
                            <option value="rombongan" {{ $kategori->jenis == 'rombongan' ? 'selected' : ''}}>Rombongan atau Kelompok</option>
                            <option value="individu" {{ $kategori->jenis == 'individu' ? 'selected' : ''}}>Individu</option>
                        </select>
                    </div>
                    <div class="mt-3">
                        <label for="crud-form-2" class="form-label">Jenis</label>
                        <select data-placeholder="-- Pilih satu --" name="doc" class="tail-select w-full" id="crud-form-2">
                            <option value="ya" {{ $kategori->doc == 'ya' ? 'selected' : '' }}>Menyertakan Document</option>
                            <option value="tidak" {{ $kategori->doc == 'tidak' ? 'selected' : '' }}>Tidak Menyertakan Document</option>
                        </select>
                    </div>
