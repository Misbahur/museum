        ...
        <div class="intro-y col-span-6 overflow-auto lg:overflow-visible">
            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box p-5">
                    <form method="POST" action="{{ route('linkadd') }}">
                    @csrf
                    <div>
                        <label for="crud-form-1" class="form-label">Nama</label>
                        <input id="crud-form-1" name="nama" type="text" class="form-control w-full" placeholder="Input nama link">
                    </div>
                    <div>
                        <label for="crud-form-3" class="form-label">Title Link Directory</label>
                        <input id="crud-form-3" name="title" type="text" class="form-control w-full" placeholder="Input Title link">
                    </div>
                    <div>
                        <label for="crud-form-4" class="form-label">Link Link Directory</label>
                        <input id="crud-form-4" name="link" type="text" class="form-control w-full" placeholder="Input Link link">
                    </div>
